...
VALUES
('Wall Squats', 2, 'Knee', 'https://video.link/squat', 'Lean against wall, lower hips until thighs are parallel to floor.', 'FITNESS'),
( 'Shoulder External Rotation', 1, 'Shoulder', 'https://video.link/shoulder', 'Keep elbow at side, rotate forearm outward with resistance band.', 'PHYSIOTHERAPIST'),
('Plank', 3, 'Core', 'https://video.link/plank', 'Hold a push-up position on your elbows for 30-60 seconds.', 'FITNESS'),
('Straight Leg Raise', 1, 'Knee', 'https://video.link/slr', 'Lie on back, keep one leg straight and lift it to 45 degrees, hold 3 seconds, lower slowly.', 'PHYSIOTHERAPIST'),
('Terminal Knee Extension', 1, 'Knee', 'https://video.link/tke', 'Loop resistance band behind knee, stand and straighten the knee fully against band resistance.', 'PHYSIOTHERAPIST'),
...
('Pendulum Exercise', 1, 'Shoulder', 'https://video.link/pendulum', 'Lean forward supported on a table, let arm hang freely and make small clockwise and counterclockwise circles.', 'PHYSIOTHERAPIST'),
('Scapular Retraction', 1, 'Shoulder', 'https://video.link/scap-ret', 'Sit or stand tall, squeeze shoulder blades together and hold for 5 seconds, release slowly.', 'FITNESS'),
('Shoulder Internal Rotation with Band', 2, 'Shoulder', 'https://video.link/ir-band', 'Elbow at 90 degrees at side, rotate forearm inward toward abdomen against resistance band.', 'PHYSIOTHERAPIST'),
( 'Overhead Press', 3, 'Shoulder', 'https://video.link/ohp', 'Hold dumbbells at shoulder height, press straight overhead until arms fully extended, lower with control.', 'FITNESS'),
( 'Dead Bug', 2, 'Core', 'https://video.link/deadbug', 'Lie on back with arms up and knees at 90 degrees, slowly lower opposite arm and leg toward floor while pressing lower back down.', 'FITNESS'),
